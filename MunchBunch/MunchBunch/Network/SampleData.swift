...
let GET_ALL_BOOKMARKS_SAMPLE: String = "{\"code\":200,\"status\":\"success\",\"data\":[{\"truck_id\":1},{\"truck_id\":4}],\"message\":\"Retrieved bookmarks for user_id: 1.\"}"

let ADD_BOOKMARK_SAMPLE: String = "{\"code\":201,\"status\":\"success\",\"data\":{\"id\":2},\"message\":\"Added new favorite.\"}"

let DELETE_BOOKMARK_SAMPLE: String = "{\"code\":200,\"status\":\"success\",\"message\":\"Removed 1 bookmark.\"}"
...
let GET_LOCAL_TRUCKS_SAMPLE: String = "{\"code\":200,\"status\":\"success\",\"data\":[{\"truck_id\":1,\"latitude\":34.022352,\"longitude\":-118.285117,\"twitter_handle\":\"@spitztruckla\",\"url\":\"https://pbs.twimg.com/media/DWqIDC7XcAEFGjt.jpg:large\",\"name\":\"SpitzTruck LA\",\"phone\":\"\",\"address\":\"Wilshire Blvd & Midvale Ave, Los Angeles, CA 90024\",\"broadcasting\":false}],\"message\":\"Retrieved all local trucks.\"}"

let GET_TRUCK_MAIN_INFO_SAMPLE: String = "{\"code\":200,\"status\":\"success\",\"data\":[{\"twitter_handle\":\"@spitztruckla\",\"name\":\"SpitzTruck LA\",\"phone\":\"\"},{\"twitter_handle\":\"@mexnchuckwagon\",\"name\":\"Mexican Chuck Wagon\",\"phone\":\"\"},{\"twitter_handle\":\"@foodismtruck\",\"name\":\"Foodism\",\"phone\":\"\"},{\"twitter_handle\":\"@RollnLobster\",\"name\":\"Roll'n Lobster\",\"phone\":\"\"},{\"twitter_handle\":\"@Bufemed\",\"name\":\"Büfe LA\",\"phone\":\"\"},{\"twitter_handle\":\"@cheddrWheel\",\"name\":\"Cheddr Wheel\",\"phone\":\"\"},{\"twitter_handle\":\"@LetsBowlIt_LA\",\"name\":\"Let's Bowl It\",\"phone\":\"\"},{\"twitter_handle\":\"@BabysBBs\",\"name\":\"Babys Badass Burgers\",\"phone\":\"\"},{\"twitter_handle\":\"@CreoleCity\",\"name\":\"Creole City\",\"phone\":\"\"},{\"twitter_handle\":\"@TokyoDoggieStyl\",\"name\":\"Tokyo Doggie Style\",\"phone\":\"\"}],\"message\":\"Retrieved all main truck data.\"}"
